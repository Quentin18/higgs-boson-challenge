...
def least_squares_loss(y: np.ndarray, tx: np.ndarray,
...
def logistic_regression_loss(y: np.ndarray, tx: np.ndarray,
                             w: np.ndarray) -> np.ndarray:
...
def reg_logistic_regression_loss(y: np.ndarray, tx: np.ndarray, w: np.ndarray,
